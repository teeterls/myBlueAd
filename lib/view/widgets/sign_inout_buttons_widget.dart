...
class ButtonQuickSignIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GradientButton(
      tooltip: "Add email account and password",
      child: Row(
      ...
      callback: () {
        Navigator.of(context).pushNamed('/useraction', arguments: "updateanonym").then((value) =>  Provider.of<UserState>(context, listen: false).user.email==value);
      },
      gradient: Gradients.cosmicFusion,
      shadowColor: Gradients.cosmicFusion.colors.last.withOpacity(
          0.25),
    );
  }
}
